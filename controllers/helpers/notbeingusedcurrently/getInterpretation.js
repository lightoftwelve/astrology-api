...
// call find all findALL.pk thing 
//convert to text to string
// use broilerplate
// deploy it
// then change frontend
// then work 
// use from the mini project

//sun, moon, mercury, venus, earth, mars, jupiter, saturn, uranus, neptune, pluto (11)
