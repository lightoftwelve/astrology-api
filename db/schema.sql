...
-- The generated_data table will store the data generated by your application. It contains a userInput field (for the user's input data), a planetaryData field (for the planetary data), an openaiResponse field (for the OpenAI response), and a userId field (for the user's ID).
